...
- *DevOps & tools: Docker, Kubernetes, Terraform, Git, CircleCI, Datadog, Webpack, NPM/Yarn, Bash/Zsh, Storybook, Jira, Figma, Prompt engineering with leading LLMs (Codex, Claude code, Gemini CLI), using tools like Cursor and Windsurf and open-source models (Hugging Face, Ollama).*